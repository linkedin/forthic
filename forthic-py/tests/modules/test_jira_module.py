...
class TestJiraModule(unittest.TestCase):
    ...
    def test_TIME_IN_STATE(self):
        ...
        changes = [
            {
                "date": datetime.datetime(2021, 7, 21, 1, 14, 57),
                "field": "status",
                "from": "",
                "to": "Open",
            },
            {
                "date": datetime.datetime(2021, 8, 23, 2, 56, 7),
                "field": "status",
                "from": "Open",
                "to": "Scoping",
                "from_": "1",
            ...
            {
                "date": datetime.datetime(2021, 9, 27, 19, 53, 39),
                "field": "status",
                "from": "Scoping",
                "to": "In Development",
                "from_": "10128",
            ...
            {
                "date": datetime.datetime(2021, 11, 4, 8, 36, 5),
                "field": "status",
                "from": "In Development",
                "to": "Closed",
                "from_": "10194",
    ...
    def test_REMOVE_FIELD_TAGS(self):
        ...
        self.assertEqual(
            "This is a sample description.  alpha  beta", self.interp.stack[0]
        )
