...
namespace HoloForrth
{
    ...
    /// </summary>
    internal class HoloForrthMain : IDisposable
    {
        ...
        Forrth forrth = new Forrth();
        // TODO: Add lexicons here
        ...
        public HoloForrthMain(DeviceResources deviceResources)
        {
            messageBuffer = new MessageBuffer(forrth);
        ...
        {
            messageBuffer.OnKeyDown(args);
        }

        public void OnKeyUp(KeyEventArgs args)
        {
            messageBuffer.OnKeyUp(args);
        }
